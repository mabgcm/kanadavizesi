...
export default function Rehberler(){return <main className="hub-page"><div className="container"><nav className="article-breadcrumb"><Link href="/">Ana Sayfa</Link> &gt; Rehberler</nav><header className="hub-intro"><h1>Kanada vizesi ve göçmenlik rehberleri</h1><span className="red-rule"/><p>Kanada’ya gitme yollarından ziyaretçi vizesine, eğitim ve çalışma seçeneklerinden kalıcı oturum ve yeni yaşam düzenine kadar bütün rehberleri tek yerde inceleyin.</p></header><GuideHub clusters={contentClusters}/></div></main>}
