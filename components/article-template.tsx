  ...
  return <main className="article-page">
    ...
    <div className="container article-shell">
      ...
      <div className="article-layout"><article data-content-status={article.contentStatus}>
        ...
        <section className="disclaimer"><strong>Bağımsızlık ve bilgilendirme notu</strong><p>KanadaVizesi.ca bağımsız bir danışmanlık kuruluşudur ve Kanada Hükümeti veya IRCC ile bağlantılı değildir. Bu içerik genel bilgilendirme amaçlıdır ve kişisel göçmenlik veya hukuk tavsiyesi değildir.</p></section>
