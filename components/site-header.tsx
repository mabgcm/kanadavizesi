...
export function Brand() {
  return (
    <Link className="logo" href="/" aria-label="KanadaVizesi.ca ana sayfa">
      <Image
        src="/canada-flag.svg"
        alt="Kanada bayrağı"
        width={76}
      ...
      <header className="top-header">
        <div className="container header-inner">
          ...
          <div className="header-tools">
            <search>
              <form className="search" action="/rehberler">
        ...
        <div className="container nav-inner">
          <details className="mobile-navigation">
            ...
            <div>
              ...
              <Link href="/on-degerlendirme">Ön Değerlendirme</Link>
            </div>
          </details>
          <nav aria-label="Ana menü">
            ...
            <Link href="/kanadada-egitim/kanadada-egitim-rehberi">Eğitim</Link>
            <Link href="/kanadada-calisma/turkiyeden-kanadada-is-bulmak">
              Çalışma
            </Link>
            <Link href="/kanada-gocmenlik/kalici-oturum-ve-express-entry">
          ...
          <Link className="sign-in" href="/on-degerlendirme">
            Ön Değerlendirme
          </Link>
        </div>
      </div>
