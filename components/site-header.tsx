...
export function SiteHeader() {
  return <>
    <header className="top-header"><div className="container header-inner"><Brand/><div className="header-tools"><Link href="/#iletisim">İletişim</Link><form className="search" action="/rehberler" role="search"><label className="sr-only" htmlFor="site-search">Sitede ara</label><input id="site-search" name="q" placeholder="Sitede ara"/><button aria-label="Ara"><Search/></button></form></div></div></header>
