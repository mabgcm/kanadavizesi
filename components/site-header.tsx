...
export function SiteHeader() {
  return <>
    ...
    <div className="nav-line"><div className="container nav-inner"><details className="mobile-navigation"><summary><Menu/> MENÜ <ChevronDown/></summary><div><Link href="/rehberler">Tüm Rehberler</Link><Link href="/kanada-vizesi/kanada-ziyaretci-vizesi">Kanada Vizesi</Link><Link href="/kanadada-egitim/kanadada-egitim-rehberi">Kanada’da Eğitim</Link><Link href="/kanadada-calisma/turkiyeden-kanadada-is-bulmak">Kanada’da Çalışma</Link><Link href="/kanada-gocmenlik/kalici-oturum-ve-express-entry">Göçmenlik</Link><Link href="/kanadada-yasam/kanadada-yasam-ve-ilk-90-gun">Kanada’da Yaşam</Link><Link href="/on-degerlendirme">Ön Değerlendirme</Link></div></details><nav aria-label="Ana menü"><Link href="/rehberler">Rehberler</Link><Link href="/kanada-vizesi/kanada-ziyaretci-vizesi">Kanada Vizesi</Link><Link href="/kanadada-egitim/kanadada-egitim-rehberi">Eğitim</Link><Link href="/kanadada-calisma/turkiyeden-kanadada-is-bulmak">Çalışma</Link><Link href="/kanada-gocmenlik/kalici-oturum-ve-express-entry">Göçmenlik</Link><Link href="/kanadada-yasam/kanadada-yasam-ve-ilk-90-gun">Kanada’da Yaşam</Link></nav><Link className="sign-in" href="/on-degerlendirme">Ön Değerlendirme</Link></div></div>
  </>;
}
